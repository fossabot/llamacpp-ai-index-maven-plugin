...
The following prompt template captures the release procedure. Paste it into a new Claude Code session, fill in the three placeholders, and send it to perform a release.
